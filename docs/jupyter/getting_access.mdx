...
import landingPage from '../hpcdocs/HPC-clusters/imgs/landingpage.001.png';
...
<div style={{ display: 'flex', justifyContent: 'center', margin: '1em 0' }}>
  <img
    src={landingPage}
    alt="Landing page for UC Merced's JupyterHub"
    style={{
      width: '60%',
      height: 'auto',
      objectFit: 'contain',
...
<<<<<<< HEAD:docs/jupyter/getting_access.md
**Zoom Details**
...
**Unforutnately we are unable to host Zoom Office hours as of now, please come visit us in ACS Room 365 or file a ServiceNow Ticket. Thank you!**

>>>>>>> d994c25b (minor image fixes, table for jupyterHub, and language tweaks):docs/jupyter/getting_access.mdx
