...
Instead of submitting 20 jobs, submit one job that runs multiple tasks internally. Download the python file <DownloadButton href="/files/run_simulation.py" label="Download run_simulation.py" />
