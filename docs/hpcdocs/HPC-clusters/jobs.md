...
Interactive jobs are a useful way to debug and test code with small sample inputs before submitting a scaled up batch job. Please visit this page for more information: [Interactive Jobs](../running-jobs/interact_job.md).
